	...
	<div class="top-header navbar navbar-default">
		...
		<div class="container">
			<div class="nav navbar-nav wow fadeInLeft animated"
				data-wow-delay=".5s">
				<p>
					Welcome to Modern Shoppe <a href="register.html">Register </a> Or <a
									...
									<div class="col-sm-3 menu-grids">
										<ul class="multi-column-dropdown">
											...
											<li><a class="list" href="products.html">Gloves &
													Mittens</a></li>
											<h4>Shop by Age</h4>
											<li><a class="list" href="products.html">New Born (0
													- 5 M)</a></li>
								...
								<div class="row">
									...
									<div class="col-sm-3 menu-grids">
										...
										<ul class="multi-column-dropdown">
											...
											<li><a class="list" href="products.html">Dhoti Kurta
													Sets</a></li>
